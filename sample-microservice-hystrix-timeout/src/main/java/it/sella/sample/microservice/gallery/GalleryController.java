...
public class GalleryController {
    ...
    @HystrixCommand(commandKey = "GetGallery",groupKey = "GalleryControllerGroup", fallbackMethod = "galleryFallBack", commandProperties = {@HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds", value = "8000")})
    @RequestMapping("/{id}")
    public Gallery getGallery(@PathVariable final int id) {
        ...
        ResponseEntity<GalleryImageList> response = restTemplate.getForEntity("http://image-service-timeout/images/", GalleryImageList.class);
